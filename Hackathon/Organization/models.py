...
class Application(models.Model):
    by_recruit=models.OneToOneField(User, on_delete=models.CASCADE)
    proposal_text=models.TextField()
    at=models.DateTimeField( auto_now=False, auto_now_add=False)
    by_whom=models.OneToOneField(Jobs, on_delete=models.CASCADE)
